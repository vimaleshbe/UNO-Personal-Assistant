...
- `assets/` — images and diagrams (SVG architecture diagram)
- `PROMPT_BOOK_NOTICE.md` — explains prompt-book exclusion
- `POSTING_GUIDE.md` — instructions & screenshot suggestions for LinkedIn/GitHub
- `LICENSE` — MIT license

How to use
- Edit or extend any `docs/*.md` files with your own wording.
- Add screenshots to `assets/screenshots/` before publishing on LinkedIn.
- This repo is safe to publish: it excludes code and prompt-book contents.

Contact
- Author: vimalesh jeyavelmani
